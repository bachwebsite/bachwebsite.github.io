    ...
    var initApp = function() {
        $(document).ready(function() {
			...
			window.idAsyncInit = function() {
				...
				ID.init({
					appId         : '541af354f411ecbe72036017',                 // App ID from the app dashboard
		...
		(function(d, s, id){
			...
			$('#cancel2 span').click(function() {
                app.animateParchment('guest', 'loadcharacter');
            });
            ...
            $('.create div').click(function(event) {
				app.tryStartingGame();
            });
			$('.play div').click(function(event) {
				app.tryStartingGame();
            });
			$('.guest-play span').click(function(event) {
				app.guestPlay = true;
				app.tryStartingGame();
            });
			
			$('.guest span').click(function(event) {
				app.animateParchment('loadcharacter', 'guest');
            });
